...
public class CustomerController {
    ...
    public ResponseEntity<Map<String, String>> verifyOtp(@RequestBody Map<String, String> body) {
        ...
        if (c.getOtpExpiryTime() == null || System.currentTimeMillis() > c.getOtpExpiryTime()) {
    ...
    public ResponseEntity<Map<String, String>> resetPassword(@RequestBody Map<String, String> body) {
        ...
        if (c.getOtp() == null || !c.getOtp().equals(otp) || c.getOtpExpiryTime() == null || System.currentTimeMillis() > c.getOtpExpiryTime()) {
